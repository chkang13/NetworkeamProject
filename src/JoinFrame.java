...
public class JoinFrame extends JFrame {
   ...
   public JoinFrame() {
      ...
      lblJoin.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 20));
      lblJoin.setBounds(159, 25, 101, 29);
      contentPane.add(lblJoin);

      JLabel lblUsername = new JLabel("Password");
      lblUsername.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 15));
      ...
      lblName.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 15));
      lblName.setBounds(69, 213, 69, 20);
      contentPane.add(lblName);

      JLabel lblEmail = new JLabel("Email");
      lblEmail.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 15));
      lblEmail.setBounds(69, 255, 69, 20);
      contentPane.add(lblEmail);

      JLabel lblPhone = new JLabel("phone");
      lblPhone.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 15));
      lblPhone.setBounds(69, 342, 69, 20);
      contentPane.add(lblPhone);

      JLabel lblNickname = new JLabel("Nickname");
      lblNickname.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 15));
      ...
      lblBirth.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 15));
      ...
      joinCompleteBtn.addActionListener(new ActionListener() {
         ...
         public void actionPerformed(ActionEvent e) {
            ...
            try {
               BufferedWriter user = new BufferedWriter(new FileWriter("C://Users//°­Ã¢ÈÆ//Desktop//UserData.txt", true));
               BufferedReader user1 = new BufferedReader(new FileReader("C://Users//°­Ã¢ÈÆ//Desktop//UserData.txt"));
               String str = null;
               ...
               while ((str = user1.readLine()) != null) {
                  ...
                  if (tfUsername.getText().equalsIgnoreCase(arr[0])) {
                     JOptionPane.showMessageDialog(null, "ÇØ´ç ¾ÆÀÌµð°¡ Á¸ÀçÇÕ´Ï´Ù! ´Ù½Ã °¡ÀÔÇØÁÖ¼¼¿ä.");
                     System.exit(0);
                  } 
               }
